...
//		else break;
//	}
//	quicksort(Y1, 0, len1 - 1, 'y');
//	quicksort(Y2, 0, len2 - 1, 'y');
//
//	int low_point = 0;
//	int flag;
//	for (int i = 0; i < len1; i++) {
//		double base_y1 = Y1[i].y - d, base_y2 = Y1[i].y + d;
//		double base_x = Y1[i].x + d;
//		flag = 1;
//		for (int j = low_point; j < len2; j++) {
//			if (flag && Y2[j].y > Y1[i].y) {
//				low_point = j;
//				flag = 0;
//			}
//			if (Y2[j].x >= base_x || Y2[j].y <= base_y1) continue;
//			else if (Y2[j].x < base_x && Y2[j].y > base_y1 && Y2[j].y < base_y2) {
...
//		Point q1, q2, q3, q4;
//		double min_dis;
//		double ldis = Divide(points, left, mid, q1, q2);
//		double rdis = Divide(points, mid + 1, right, q3, q4);
//		if (ldis < rdis) {
//			p1 = q1, p2 = q2;
//			min_dis = ldis;
//		}
...
//			min_dis = rdis;
//		}
//		min_dis = Merge(points, left, right, mid, min_dis, p1, p2);
//		return min_dis;
//	}
//}
//
...
//		printf("分治法策略三——最近点对为(%.2lf,%.2lf)和(%.2lf,%.2lf),最近距离为%lf\n", p3.x, p3.y, p4.x, p4.y, ans2);
//
//		delete[]points;
//	}
//	return 0;
